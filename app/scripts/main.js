...
$(document).ready(function() {
  ...
  $('h1 > span').fitText(1.2, { minFontSize: '40px', maxFontSize: '72px' });

  // lodging
  $('.btn-lodging').on('click', function() {
    window.open('https://drive.google.com/file/d/0B3cw4dG_TxovR0ltQnVqeDdYRlk/view?usp=sharing');
  });

  // registry
  $('.btn-registry').on('click', function() {
    window.open('http://tendr.com/mvp-wedding');
  });
